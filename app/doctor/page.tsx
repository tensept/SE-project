...
const MessageItem: React.FC<MessageProps> = ({ sender, time, isRead, id  }) => {
  ...
  const handleClick = () => {
    router.push(`/history`); // นำทางไปที่หน้า message/[id]
  };
  return (
    <div
...
const HealthDiaryMessages: React.FC = () => {
  ...
  const messages = [
    { id: 1, sender: "Guillermo Rauch", time: "5:48 PM", isRead: true },
    { id: 2, sender: "Guillermo Rauch", time: "5:48 PM", isRead: true },
    { id: 3, sender: "Guillermo Rauch", time: "5:48 PM", isRead: false },
    { id: 4, sender: "Guillermo Rauch", time: "5:48 PM", isRead: false },
    { id: 5, sender: "Guillermo Rauch", time: "5:48 PM", isRead: false },
    { id: 6, sender: "Guillermo Rauch", time: "5:48 PM", isRead: false },
  ];
      ...
      <div className="flex-1 p-4">
        ...
        <div className="space-y-1">
          {messages.map(message => (
            <MessageItem key={message.id} sender={message.sender} time={message.time} isRead={message.isRead} id={0} />
          ))}
        </div>
      </div>
    </div>
